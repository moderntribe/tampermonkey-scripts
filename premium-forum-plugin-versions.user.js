...
(function() {
    ...
    // Current eCommerce versions
    var currwoover = "3.4.2";
    var curreddver = "2.9.3";
    var ecmUsed, userEcmVer;

    var i, k, inReply, replyHtml;
    ...
    htmlstring += '<tr class="row"><td>May 29</td><td>M18.08</td><td class="new-version">4.6.17</td><td class="new-version">4.4.27</td><td class="new-version">4.7.3.1</td><td class="new-version">4.7.3</td><td>4.4.9</td><td class="new-version">4.5.12</td><td>4.5.4</td><td class="new-version">4.5.6</td><td>4.4</td><td>1.0.2</td></tr>';
    htmlstring += '<tr class="row last-row alwayson"><td>Jun 4</td><td>ETR</td><td class="new-version" id="currtecver">4.6.18</td><td id="currprover">4.4.27</td><td id="curretiver">4.7.3.1</td><td id="curretpver">4.7.3</td><td class="new-version" id="currebtver">4.5</td><td id="currcevver">4.5.12</td><td id="currctxver">4.5.4</td><td id="currfibver">4.5.6</td><td id="currapmver">4.4</td><td id="curriwpver">1.0.2</td><td id="currecmver">';
    if ( ecmUsed == "woo" ) {
        htmlstring += currwoover;
        userEcmVer = pluginVersions.woo.version
    }
    else if ( ecmUsed == "edd" ) {
        htmlstring += curreddver;
